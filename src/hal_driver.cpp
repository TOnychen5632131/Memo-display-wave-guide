...
#include <Arduino.h>
// 引脚定义
#define TFT_CLK GPIO_NUM_4
#define TFT_CS0 GPIO_NUM_14
#define TFT_CS1 GPIO_NUM_18
#define TFT_D0 GPIO_NUM_6
#define TFT_D1 GPIO_NUM_8
#define TFT_D2 GPIO_NUM_10
#define TFT_D3 GPIO_NUM_12
